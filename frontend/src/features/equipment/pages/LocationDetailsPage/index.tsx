  ...
  const summaries: LocationDetailSummary[] = [
    {
      ...
      value: location.equipmentSummary?.total ?? 0,
      description: 'Vinculados a este local',
    },
    {
      id: 'available',
      title: 'Disponíveis',
      value: location.equipmentSummary?.available ?? 0,
      description: 'Prontos para uso',
    },
    {
      id: 'maintenance',
      title: 'Em Manutenção',
      value: location.equipmentSummary?.inMaintenance ?? 0,
      description: 'Sendo reparados',
    },
    {
      id: 'inactive',
      title: 'Inativos',
      value: location.equipmentSummary?.inactive ?? 0,
    ...
    <AppLayout currentPage="Detalhes">
      <Container>
        <DetailsHeader
          ...
          onChangeStatus={() => setLocationInStatus(location)}
        ...
        <ContentGrid>
          <MainColumn>
            ...
            <LocationNotesCard notes={location.description} />
          </MainColumn>
